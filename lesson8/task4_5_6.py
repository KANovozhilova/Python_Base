...
Продолжить работу над заданием. Разработать методы, отвечающие за приём оргтехники на склад и передачу
...
if __name__ == "__main__":
    printer_1 = Printer("Принтер1", 5500, True, "N1111")
    printer_2 = Printer("Принтер2", 6600, False, "N2222")
    printer_3 = Printer("Принтер3", 7700, True, "N3333")
    scanner_1 = Scanner("Сканер1", 6000, "4800x4800", "N111")
    copier_1 = Copier("Ксерокс1", 5000, False, "4800x600", 8, "N11")
    copier_2 = Copier("Ксерокс2", 10000, True, "2400x600", 30, "N22")
